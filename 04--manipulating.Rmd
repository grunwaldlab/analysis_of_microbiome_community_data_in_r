...
**10a)** The function `calc_n_samples` from the `metacoder` package returns the proportion of samples each OTU appears in (i.e. has a non-zero count): 
...
**10c)** What are the families of the OTUs most "characteristic" of roots vs leafs?
