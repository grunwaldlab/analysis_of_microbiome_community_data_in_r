...
The main version of RStudio that most people use, which is free and open source, can be downloaded here:
...
RStudio records your command history. Thus you can scroll up or down the history of executed commands using the *Up* or *Down* arrows.
...
Instead, you can move the cursor to the line you want to run in the text editor and <kbd>Ctrl</kbd> + <kbd>Enter</kbd> to copy, paste, and execute the line in the console.
