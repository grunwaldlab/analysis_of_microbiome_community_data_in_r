...
Although it might seems that the purpose of the code you just wrote is obvious, it will probably be much less clear in a month or two.
Be kind to your future self or any other unfortunates that must interpret this code and use comments.
Comments are parts of text that R ignores and programmers use to leave notes.
