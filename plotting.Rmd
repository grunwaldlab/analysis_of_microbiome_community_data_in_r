...
Lets set the color to the read abundance for one of the samples named "M1981P563".
...
obj %>%
  ...
  heat_tree(node_label = taxon_names,
            node_size = n_obs,
            node_color = M1977P1709,
            initial_layout = "re", layout = "da",
            output_file = "plot_example_2.pdf")
```


The `heat_tree` function is very complex and we have only used its most basic functionality so far.
