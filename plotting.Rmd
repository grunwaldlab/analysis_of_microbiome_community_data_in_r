...
As with many other functions from `taxa` and `metacoder`, any table column or function associated with the `taxmap` object being plotted can be refereed to as if it was an independent variable in the function call.
